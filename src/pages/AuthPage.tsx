...
const AuthPage = () => {
  ...
  const handleGoogleSignIn = async () => {
    ...
    // Standard web path: Supabase native Google sign-in (direct redirect to Google accounts)
    try {
        ...
        <Card className="glass-strong border-border/50 shadow-2xl backdrop-blur-xl">
          ...
          <CardContent>
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="w-full mb-4 flex items-center justify-center gap-3 transition-colors hover:bg-accent/50"
